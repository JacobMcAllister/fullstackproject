defmodule InClassWeb.DeveloperControllerTest do
  use InClassWeb.ConnCase

  import InClass.CompanyFixtures

  @create_attrs %{email: "some email", expertise: "some expertise", first_name: "some first_name", last_name: "some last_name"}
